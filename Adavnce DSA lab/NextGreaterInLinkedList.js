...
const head2 = buildList([2, 7, 4, 3, 5]);
console.log(nextGreaterInLinkedList(head2));

const head3 = buildList([1, 7, 5, 1, 9, 2, 5, 1]);
console.log(nextGreaterInLinkedList(head3));